...
def overzicht(lijst):
    for i in range(6):
        print(str(lijst[i].get_naam()) + '           ' + str(lijst[i].get_leeftijd()) + '    ' + str(lijst[i].get_kinderen_ten_laste()) + '            ' + str(lijst[i].get_type_arbeidsovereenkomst()) + '     ' + str(lijst[i].get_maandwedde()))


def arbeiders_overzicht(lijst):
    for i in range(3):
        print(str(lijst[i].get_naam()) + '           ' + str(lijst[i].get_leeftijd()) + '    ' + str(lijst[i].get_kinderen_ten_laste()) + '     ' + str(lijst[i].get_maandwedde()))
...
print('naam    leeftijd kind arbeidsovereenkomst maandwedde')
overzicht(lijst)
print('Overzicht arbeiders:')
print('naam    leeftijd kind maandwedde')
